...
class PyGroup:
    def __init__ (self):
        ...
        self._total_id = 0 
        self._total_n = 0
        self._vetorclock = [0] #18/06/2019
        self._counter = 0 #18/06/2019
    ...
    def _mynumber (self): #CODIGO ADICIONADO 17/06/2019 L.S.
        return self._members.index(Member(self._myself(), self._status)) #18/06/2019
